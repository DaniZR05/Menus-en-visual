...
namespace Menus_en_visual
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Este programa fue creado por Bryan Daniel Zarate Ramos","Acerca de...",MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
